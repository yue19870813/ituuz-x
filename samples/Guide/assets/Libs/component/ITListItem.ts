...
@ccclass
@disallowMultiple()
@menu("IT Component/ITListItem")
@executionOrder(-5001)// 先于List
export default class ITListItem extends cc.Component {
    // 图标
    ...
    public showAni(aniType: number, callFunc: () => void, del: boolean) {
        let acts: any[];
        switch (aniType) {
            case 0: // 向上消失
                acts = [
